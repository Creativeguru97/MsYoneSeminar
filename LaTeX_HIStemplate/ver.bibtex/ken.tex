...
%和文タイトル
\jtitle{ヒューマンインタフェース研究報告集　原稿執筆の手引き}

%著者日本名
\jauthor{
ヒューマン　太郎\thanks{ヒューマン大学大学院　工学研究科}　　
ヒューマン　花子\thanks{ヒューマンインタフェース学会株式会社　中央研究所}　　
ヒューマン　次郎\addtocounter{footnote}{-2}\footnotemark
}

%英文タイトル
\etitle{Guideline of Writing Manuscript for Correspondences of Human Interface Society}

%著者英文名
\eauthor{
Taro Human\thanks{Graduate School of Engineering, Human University},
Hanako Human\thanks{Central Research Laboratory, Human Interface Society Ltd.} and 
Jiro Human\addtocounter{footnote}{-2}\footnotemark
}
...
%%    \includegraphics[width=70mm, bb=0 0 200 80]{fig1.bmp}
%%    \includegraphics[width=70mm, bb=0 0 200 80]{fig1.jpg} %%jpgを使用するためには、Susieプラグイン等が必要です
